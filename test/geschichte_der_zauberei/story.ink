...
Die Geschichte der Zauberei wurde seit jeher von den erfahrendsten und ehrwürdigsten Lehrern an dieser Schule gelehrt, und dies soll auch in Zukunft so bleiben. Um aber mit der fortschreitenden Technik weiterhin Schritt halten zu können, gibt es nun erste Versuche, einen Teil des Lehrplans in Form der sogenannten "Elektronischen Daten Verarbeitung" anzubieten.  Es liegt Ihnen, werter Schüler dieser Institution, mit diesem Tablet daher eine interaktive Lehrstunde zur "Geschichte der Zauberei" vor.
...
= erwischt
DIE TROLLE! SIE KOMMEN IMMER NÄHER!
...
+   Gehe vorsichtig vor bis zur Tafel am Ende des Saales.
    Auf halbem Wege hörst du, wie etwas schweres gegen die Eingangstore schlägt.
    ++  Gehe weiter zum Ende des Saales.
    ++  Gehe zurück zum Eingang des Festsaales.
    --  Die Tore geben nach und schwingen mit einem Knirschen auf. Vier Trolle stehen in der Eingangshalle und schauen in meine Richtung!!!
        +++ Verstecke dich unter dem nahesten Tisch.
        +++ Renne zum Ende des Saales.
+   Verstecke dich unter dem nahesten Tisch.
    Die Tore geben nach und schwingen mit einem Knirschen auf. Vier Trolle stehen in der Eingangshalle und schauen in meine Richtung!!!
    ++  Sie können mich wittern!!!
        -> erwischt
+   Gehe zurück zur Eingangshalle.
    Etwas schweres schlägt gegen die Eingangstore!
    ++  Renne zur großen Treppe in der Eingangshalle
        -> treppe
    ++  Renne zum Eingangstor
        Die Tore geben nach und schwingen mit einem Knirschen auf. Vier Trolle stehen in der Eingangshalle und schauen in meine Richtung!!!
-
-> erwischt
...
+   STUPOR!
    ...
    ++  EXPELIARMUS!
        ...
        ---
        -> flur
    ++  Ich laufe die Treppe hinauf.
    --
    -> flur

+   Renne die Treppe empor!
...
Hinter mir das Keuchen der Trolle, die wohl nicht mitbekommen haben, wo ich hingelaufen bin...
-> ersterStock

= ersterStock

Vor mir die Flure im ersten Stock!

+   weiter geradeaus
    Hier sind die Lichter alle aus?!
    Es ist kaum etwas zu erkennen; da!? war das ein Lichtschein vor mir im Gang?
    ++  Ich untersuche den Lichtschein im Gang vor mir.
        NEIN! Das war der Helm eines Trolles. Ich bin fast in ihn hineingelaufen.
    ++  Ich versuche, die Fackeln wieder zu entzünden!
        Eine doofe Idee! Da vorne steht ein Troll mit dem Rücken zu mir. Zum Glück hat er mich nicht bemerkt.
    --
    Langsam schleiche ich mich wieder zurück...
    -> ersterStock

+   nach links durch die kleine Tür
...
+   nach rechts die Empore entlang
    ...
    ++  Zurück zur Treppe!
        ...
        -> erwischt
    ++  Weiter die Empore zur nächsten Treppe!
        Sie brüllen los!!
        Ich muss hier weg!!!
-

Die Gemälden an den Wänden gestikulieren wild! Sie zeigen ständig in meine Richtung...
Wollen Sie die Trolle etwa weiter anstacheln?!

+   [weiter...]
-

Nein. Sie wollen mich WARNEN. Der größte Troll ist ja genau hinter mir!!!

+   Ich schreie vor Angst.
    -> erwischt
+   Ich werfe mich zur Seite.
    BAMM! Die Trollfaust zertrümmert die Stufe, auf der ich gerade noch stand.
    ++  Ich schlage den mächtigen Trollarm direkt neben mir!
        AUTSCH! Meine Hand...
        -> erwischt
    ++  Ich hechte nach vorne auf den nächsten Treppenabsatz.
...
+   [weiter...]
-
Ich schaue mich um; da, dass muss die Wendeltreppe zum Wahrsagerturm sein.
...
= konzilFrage
Frage: Was war das aussergewöhnliche an diesem Konzil?

+   Es nahm keine einzige Hexe daran teil.
+   Während des gesamten Konzils hat es nur geregnet.
+   Bei einer Verhandlung hatten drei Wahrsagerinnen die gleiche Vision.
    -> aufgabe
+   Es wurde die Gründung der Hogwarts Schule für Zauberei bekanntgegeben.
-
Dies ist leider nicht richtig!
...
Die übereinstimmende Vision besagte, dass nur einer der Beschuldigten vor Gericht die Wahrheit sprach (Interessanterweise ist der eigentliche Gegenstand der Verhandlung nicht überliefert worden.)
